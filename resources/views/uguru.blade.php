  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><b>Page</b>&nbsp;Update Data Guru</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
			...
			<div class="card mt-2">
				...
				<div class="card-body justify-">
					<form action="/updateguru/{{ $data->id }}" method="POST" enctype="multipart/form-data">
						...
						<div class="mb-3">
							<input type="text" name="nomorhp" class="form-control mt-3" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->nomorhp }}">
						</div>
						<div class="mb-3">
